...
import {AddNewProductEventStream, AddNewProductsStateHandler, ProductDateStateHandler, StructureProductTileModel, StructureProductTileModelBuilder} from './model';
...
export class StructuredProductTileViewFactory extends ViewFactoryBase<PolimerModel<StructureProductTileModel>, { }> {
    ...
    _createView(childContainer): PolimerModel<StructureProductTileModel> {
        ...
        let polimerModel = this._router
            ...
            .withStateHandlerObject('products', new AddNewProductsStateHandler())
