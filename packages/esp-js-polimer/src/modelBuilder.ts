...
import {PolimerModel, PolimerModelInitialConfig} from './polimerModel';
...
export class PolimerModelBuilder<TModel extends ImmutableModel, TPersistedModelState = {}> extends PolimerModelBuilderBase<TModel> {
    ...
    registerWithRouter(): PolimerModel<TModel> {
        ...
        let polimerModel = new customPolimerModel(
            this._router,
            <PolimerModelInitialConfig<TModel>>{
