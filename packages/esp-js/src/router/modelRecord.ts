...
export type EventRecord = {modelPath: string, eventType: string, event: any, action:  (model: any) => void};
...
export class ModelRecord {
    ...
    public tryEnqueueEvent(modelPath: string, eventType: string, event: any): boolean {
        ...
        this.eventQueue.push({modelPath, eventType: eventType, event: event, action: null});
        return true;
    }
