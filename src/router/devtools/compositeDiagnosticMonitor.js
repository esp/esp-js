...
export default class CompositeDiagnosticMonitor extends DisposableBase {
    constructor() {
        super();
    ...
    eventEnqueued(modelId) {
        this._currentLoggingDiagnosticMonitor.eventEnqueued(modelId);
        this._devToolsDiagnostic.eventEnqueued(modelId);
    }
